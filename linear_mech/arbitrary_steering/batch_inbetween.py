...
for img_id in images_in_main_img_dir:
    object3, _, object1, _, object2, bool_val = img_id.removesuffix(".png").split("_")
    if bool_val == "true":
        leftright_tracker[img_id] = "true"
    else:
        leftright_tracker[img_id] = "false"
...
for img_id in tqdm(images_in_main_img_dir):
    ...
    # now make query:
    unified_query = f"Is the {object3} in between {object1} and {object2}?"
    subj1, obj1 = object3, object1
    ...
    text_prompt = "QUESTION: " + unified_query + "Answer Yes or No. ANSWER: "
    ...
    for layer in range(12, 15):  # [5, 14, 16, 20, 30]:
        ...
        for coord_1 in one_coord_list:
            ...
            left_id = tokenizer.convert_tokens_to_ids("▁Yes")
            right_id = tokenizer.convert_tokens_to_ids("▁No")
